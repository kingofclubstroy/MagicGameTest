...
public class SpriteSheetRendererViewportTest : ComponentSystem {
    ...
    [BurstCompile]
    private struct CullAndSortNativeQueueJob : IJobForEachWithEntity<Translation, SpriteSheetComponentData> {
    ...
    private void InitDrawMeshInstancedSlicedData() {
        ...
        mesh = GameEntity.GetInstance().quadMesh;
        material = GameEntity.GetInstance().walkingSpriteSheetMaterial;
    }
